...
<link href="<%=ctxPath%>/static/css/H-ui.login.css" rel="stylesheet" type="text/css" />
<title>后台登录(管理员系统)</title>
</head>
<body>
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="<%=ctxPath%>/adminUser/login" method="post">
      <div class="row cl">
...
<div class="footer" style="font-size: 12px;">后台登录(管理员系统)</div>
</body>
</html>